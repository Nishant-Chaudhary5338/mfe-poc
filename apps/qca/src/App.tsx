...
const navItems = [
  ...
  { path: '/reports', label: 'Reports',   icon: '📋', end: false },
  { path: '/rules',   label: 'Rules',     icon: '📐', end: false },
      ...
      <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <nav style={{ width: 220, background: COLOR_DARK, display: 'flex', flexDirection: 'column', flexShrink: 0, overflow: 'hidden' }}>
          <div style={{ padding: '20px 16px 16px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{ fontFamily: "'Sora', sans-serif", fontSize: 12, fontWeight: 700, color: 'white', lineHeight: 1.2 }}>QC Automation</div>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <div style={{
            ...
            <span style={{ fontSize: 13, color: '#64748B', fontWeight: 500 }}>Pass rate: 96.4% · 284 checks today</span>
